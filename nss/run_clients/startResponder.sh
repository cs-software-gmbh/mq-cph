...
run -cpu=${cpu} cph -vo 4 -ss 0 -ms 2048 -rl 60 -tc Responder -iq REQUEST -oq REPLY -cr -to -1 -db 1 -dx 1 -dn 1 -pp -tx -jb PERF0 -jt mqb -nt 1
#run -cpu=${cpu} cph -vo 4 -ss 0 -ms 2048 -mg 32768 -tc Responder -iq REQUEST -oq REPLY -cr -to -1 -db 1 -dx 1 -dn 1 -pp -tx -jb PERF0 -jt mqb -nt 1
